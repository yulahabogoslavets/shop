...
<button
	class="w-full rounded-full bg-sky-700 px-4 py-2 text-white transition-colors duration-300 hover:cursor-pointer hover:bg-sky-800 focus:bg-sky-800 disabled:cursor-not-allowed disabled:bg-gray-500 md:w-fit"
